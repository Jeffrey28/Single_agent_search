...
This paper presents a measurement dissemination-based distributed Bayesian filtering (DBF) method for a multi-UGV network, utilizing the Latest-In-and-Full-Out (LIFO) local exchange protocol of observations.
