...
\cite{gu2007distributed} presented a distributed particle filter for target tracking over sensor networks. 
...
\begin{figure}%[thpb]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/com_topo}
...
\todohere{should the individual PDf always be italic throughout the paper?}
...
\begin{align}\label{eqn:bayes_upd}
...
\begin{figure}%[thpb]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/data_exchange}
...
\begin{figure}%[thpb]
	\centering
	\includegraphics[width=0.5\textwidth]{figures/DBF_demo}
...
\todohere{shorten the formula length}
For the $i^\text{th}$ robot at $k^\text{th}$ step, the \textbf{LEO-DBF} for moving target is:
\begin{enumerate}
	\item \textbf{The stored individual PDF for $(k-N)^\text{th}$ step is:}
	
	$ P^i_{PDF}(x^T_{k-N}|z^1_{1:k-N},\dots,z^N_{1:k-N})$.
	\item \textbf{Initialize a virtual PDF by assigning the individual PDF to it:}
	
	$P_{virt}(x^T_{k-N})=P^i_{PDF}(x^T_{k-N}|z^1_{1:k-N},\dots,z^N_{1:k-N})$
	\item \textbf{From $\xi=1$ to N, repeat two steps of Bayesian filtering:}
	\begin{enumerate}
		\item Prediction 
		\begin{align*}
	...
	\item \textbf{Store the first-step virtual PDF as the $(k-N+1)^\text{th}$ individual PDF:}
...
where $\Omega^i_{k-N+\xi}$ denotes the index set of robots whose observation at time $k-N+\xi$ is stored in $i^\text{th}$ robot's CB. 
...
\begin{equation}\label{eqn:cmp_log}
...
\begin{equation}\label{eqn:cmp_lim2}
...
\end{lem}
\begin{proof}
Let $n^{i,k}_j$ denote the times that $i^\text{th}$ robot visits $j^\text{th}$ state in $Y^R$ up to time $k$. Then, $\sum\limits_{j} n^{i,k}_j=k$. It is straightforward to see that $\exists n^{i,k}_j,$ such that $n^{i,k}_j\longrightarrow \infty,$ as $k\longrightarrow \infty$.
\end{proof}
...
\todohere{add a plot to show the entropy for three simulations}
...
The positions of six static sensors are shown as stars in \todohere{use cite: Figure 5}.
Each sensor constantly receives binary observations of the target.
...
Figure 6 shows the decrease of the entropy of the posterior distribution \todohere{add a ref}, indicating the uncertainty reduction of the estimated target position.

\begin{figure}%[thpb]
	\centering
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/sta_sen_sta_tar_1}
		\caption{Time Step: 1}\label{fig:sta_sen_sta_tar1}
	\end{subfigure}
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/sta_sen_sta_tar_3}
		\caption{Time Step: 3}\label{fig:sta_sen_sta_tar2}
	\end{subfigure}
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/sta_sen_sta_tar_10}
		\caption{Time Step: 10}\label{fig:sta_sen_sta_tar3}
	\end{subfigure}
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/sta_sen_sta_tar_50}
		\caption{Time Step: 50}\label{fig:sta_sen_sta_tar4}
	\end{subfigure}
...
Figure 8 shows the decrease of the entropy of the posterior distribution.

\begin{figure}%[thpb]
	\centering
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/mov_sen_sta_tar_1}
		\caption{Time Step: 1}\label{fig:mov_sen_sta_tar1}
	\end{subfigure}
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/mov_sen_sta_tar_3}
		\caption{Time Step: 3}\label{fig:mov_sen_sta_tar2}
	\end{subfigure}
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/mov_sen_sta_tar_10}
		\caption{Time Step: 10}\label{fig:mov_sen_sta_tar3}
	\end{subfigure}
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/mov_sen_sta_tar_30}
		\caption{Time Step: 50}\label{fig:mov_sen_sta_tar4}
	\end{subfigure}
...
\begin{figure}%[thpb]
	...
	\begin{subfigure}[b]{0.2\textwidth}
		...
		\caption{Time Step: 1}\label{fig:mov_sen_mov_tar1}
	\end{subfigure}
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/mov_sen_mov_tar_3}
		\caption{Time Step: 3}\label{fig:mov_sen_mov_tar2}
	\end{subfigure}
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/mov_sen_mov_tar_10}
		\caption{Time Step: 10}\label{fig:mov_sen_mov_tar3}
	\end{subfigure}
	\begin{subfigure}[b]{0.2\textwidth}
		\includegraphics[width=\textwidth]{figures/mov_sen_mov_tar_30}
		\caption{Time Step: 50}\label{fig:mov_sen_mov_tar4}
	\end{subfigure}
