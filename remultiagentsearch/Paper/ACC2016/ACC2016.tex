...
\cref{fig:entropy} (a) shows the decrease of the entropy of the posterior distribution \todohere{add a ref}, indicating the uncertainty reduction of the estimated target position.
