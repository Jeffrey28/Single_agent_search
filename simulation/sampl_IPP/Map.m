...
% add a name property, show in char()
    ...
    properties
        ...
        % self-added
        probmap % probability map in the form of grid map
        obsmap % obstacle map, including the coordinates of obstalces [ll,ul,ur,lr]
...
%             map.verbose = opt.verbose;
            ...
            % don't understand why verargin is a cell, though the original data
            % is a struct
            map.probmap = varargin{1}.probmap;
            map.obsmap = varargin{1}.obsmap;
            map.tarpos = varargin{1}.tarpos;
