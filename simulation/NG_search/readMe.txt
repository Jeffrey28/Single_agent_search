...
Robot7.m (not there yet): robot class. same as Robot6.m except that I now modify it to work with pedestrian motion model. Some states are not directly measurable.
