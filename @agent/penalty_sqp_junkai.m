...
% 
% % t
% t = cfg.merit_coeff_increase_ratio;
% 
% % delta
% delta = cfg.cnt_tolerance;
% 
% beta_shrink = cfg.trust_shrink_ratio;
% beta_expand = cfg.trust_expand_ratio;
% 
% % alpha
% alpha = cfg.improve_ratio_threshold;
...
while true
    ...
    if(hinge(g(x)) + abssum(h(x)) < cfg.cnt_tolerance || num_iter > cfg.max_iter)
        break;
    end
...
function [x, trust_box_size, success] = minimize_merit_function(x, Q, q, f, A_ineq, b_ineq, A_eq, b_eq, g, h, cfg, penalty_coeff, trust_box_size)
