...
\begin{figure}%[thpb]
	...
	\end{subfigure}
	\caption{(a)-(d) The $1^\text{st}$ robot's individual PDFs at different times; (e)-(h) The $3^\text{rd}$ robot's individual PDFs at different times; (i)-(l) The $5^\text{th}$ robot's individual PDFs at different times. Robots are numbered counterclockwise, with the left-most robot being the $1^\text{st}$. The square denotes the current robot and stars represent other robots. The cross stands for the target position.}
