...
% this one seems to be not the same as what I need for rbf. Actually, this
% returns a square matrix for rbf. However, in GP, the rbf can give other
% sizes of kernel matrix. I rename this one to be rbf_web instead of the 
% original name rbf-- Chang 2/14/15
n=size(coord,1);
K=coord*coord'/sig^2;
d=diag(K);
K=K-ones(n,1)*d'/2;
